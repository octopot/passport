...
var _staticScriptsPassportJs = []byte("\x1f\x8b\x08\x00\x00\x00\x00\x00\x00\xff\x01\x00\x00\xff\xff\x00\x00\x00\x00\x00\x00\x00\x00")
...
func staticScriptsPassportJs() (*asset, error) {
	...
	info := bindataFileInfo{name: "static/scripts/passport.js", size: 0, mode: os.FileMode(420), modTime: time.Unix(1521808686, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
